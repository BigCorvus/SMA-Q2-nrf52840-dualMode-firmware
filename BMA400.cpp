...
// writeByte(BMA400_ADDRESS,BMA400_AUTOLOWPOW_1, 0x04);             // switch to low power after time out (max 10.2 sec)
  ...
  /* Enable interrupts */
   ...
   writeByte(BMA400_ADDRESS,BMA400_INT_CONFIG1,  0x01);           // enable step counting
}
...
void BMA400::activateStepCounting()
{
  writeByte(BMA400_ADDRESS,BMA400_INT_CONFIG1,  0x01);           // enable step counting
}
...
unsigned long BMA400::readBMA400StepCount(){
  uint8_t stepcount0 = readByte(BMA400_ADDRESS, BMA400_STEP_CNT_0);    // Read the raw data register 
  uint8_t stepcount1 = readByte(BMA400_ADDRESS, BMA400_STEP_CNT_1);
  uint8_t stepcount2 = readByte(BMA400_ADDRESS, BMA400_STEP_CNT_2); 
  return stepcount0 + 256 * stepcount1 + 65536 * stepcount2; //24 bit data, datasheet page 66,67
}

void BMA400::resetBMA400StepCount(){
